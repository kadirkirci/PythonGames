# -*- coding: utf-8 -*-
"""
Created on Sun Jan 16 19:54:31 2022

@author: Kadir
"""

def find_next_empty(puzzle):
    # finds next row, col on the puzzle that's not filled yet --> rep -1
...
def is_valid(puzzle, guess , row, col):
    ...
    # returns True if is valid, false is not valid
    
    # let's start with the row:
    row_vals = [puzzle[row][i] for i in range(9)]
    ...
    # and then the square
    # this is the tricky, but we want to get where the 3x3 square starts
